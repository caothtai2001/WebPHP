<?php 
  ...
  $sql = "SELECT * FROM duan WHERE tennv = '$fullname' and trangthai='in process'";
      ...
      <table class="table table-hover table-striped rounded-3">  <!-- table-striped là tô màu xen kẽ -->
        ...
        ?>                                                                    
                            <tr class="item">
                                ...
                                <td><?=$duan7?></td>  
                                <td>
                                  <a class="btn btn-success" href="manage_mytaskinprocess.php?mada=<?=$duan1?>">Hoàn thành</a>                             
                                </td>                       
                            </tr>
                          <?php
                          }
...
// lấy giá trị
$mada="";
if(isset($_GET["mada"])) { $mada = $_GET['mada']; 
  {

    }}

    $sql="UPDATE duan SET trangthai='waiting' WHERE mada=?";
    $stm=$conn->prepare($sql);

    $stm->bind_param("s",$mada);
