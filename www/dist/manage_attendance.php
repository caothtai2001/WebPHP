<?php 
  session_start();
    ...
    $permission = $_SESSION['permission'];
		...
		if ($permission != '1') {
			...
			header('Location: manage_attendance_admin.php');
			exit();
		}  
  $user = $_SESSION['user'];
  $b = 1;
  ...
  $sql = "SELECT * FROM xinnghiphep WHERE machucvu = '$machucvu' and phongban='$phongban' and trangthai='waiting' ";
...
<div class="main">
  ...
  <div class="p-5 bg-primary text-white text-center">
    <h1>Danh sách đơn xin nghỉ phép đang chờ duyệt</h1>
  </div>
      ...
      <table class="table table-hover table-striped rounded-3">  <!-- table-striped là tô màu xen kẽ -->
        ...
        ?>                                                                    
                            <tr class="item">
                                ...
                                <td>
                                <a class="btn btn-outline-primary" href="attendancedetail.php?madonxnp=<?=$xinnghiphep1?>">Truy cập</a>                             
                                </td> 
                                <td>
                                  <a type="button" onClick="window.location.href=window.location.href" class="btn btn-outline-primary btnaccept" href="manage_attendance.php?id=<?=$xinnghiphep1?>">
                                  Đồng ý</a>
                                </td>
                                <td>
                                  <a type="button" onClick="window.location.href=window.location.href" class="btn btn-danger btnaccept"  href="manage_attendance.php?id1=<?=$xinnghiphep1?>">
                                  Từ chối</a>
                                </td>
