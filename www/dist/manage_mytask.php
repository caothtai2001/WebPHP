<?php 
  ...
  $sql = "SELECT * FROM duan WHERE tennv = '$fullname' and trangthai='New' ";
      ...
      <table class="table table-hover table-striped rounded-3">  <!-- table-striped là tô màu xen kẽ -->
        ...
        ?>                                                                    
                            <tr class="item">
                                ...
                                <td><?=$duan7?></td>  
                                <td>
                                  <a class="btn btn-outline-success" href="manage_mytask.php?mada=<?=$duan1?>">Bắt đầu</a>                             
                                </td>                       
                            </tr>
                          <?php
                          }
...
if(isset($_GET["mada"])) { $mada = $_GET['mada']; 
  {
    ...
    $sql="UPDATE duan SET trangthai='in process' WHERE mada=?";
