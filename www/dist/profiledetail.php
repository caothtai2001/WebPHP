...
<div class="main">
    <div class ="profiledetail">
        ...
        $sql = "UPDATE nhanvien set chucvu='Trưởng phòng'where cccd='$cccd' ";
        $result2 = $conn->query($sql);
        $sql = "UPDATE nhanvien set chucvu='Nhân viên'where cccd!='$cccd' and phongban='$humanphongban' ";
        $result3 = $conn->query($sql);
        $sql="UPDATE login set permission=0 WHERE user!='$cccd' and phongban='$humanphongban'";
        $result4 = $conn->query($sql);
        $sql="UPDATE login set permission=1 WHERE user='$cccd' and phongban='$humanphongban'";
        ...
        <div class = "dong1 row justify-content-center">
            <div class="profilecarddetail">
                ...
                <form action="profiledetail.php" method="POST">
                    <input onClick="window.location.href=window.location.href" type="button" class="btn thangchuc btn-outline-success" chucvu="<?=$humanchucvu?>" name="button" value="Thăng chức" >
                </form>
            </div>
        </div>
    </div> 
